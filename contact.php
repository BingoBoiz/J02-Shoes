                       ...
                       <div class="container">
                          <form action="contact_perform.php" method="post">
                            <div class="form-group">
                              <input type="text"  class="email-bt" placeholder="Họ & tên" name="txtTen" required style="font-family: Arial;">
                            </div>

                            <div class="form-group">
                              <input type="text" class="email-bt" placeholder="Số điện thoại" name="txtSodt" required style="font-family: Arial;">
                            </div>
                            ...
                            <div class="form-group">
                                <textarea class="massage-bt" placeholder="Nội dung" rows="5" id="comment" name="txtNoidung" required style="font-family: Arial;"></textarea>
                            </div>
