...
$query = "SELECT * FROM tbl_san_pham LIMIT $start_from, $per_page_record WHERE danh_muc_id = ".$id_dm." ";

$rs_result = mysqli_query ($ket_noi, $query);*/

?>
  <div class="collection_text">Product by category</div>
        ...
        <div class="container">
            <div style="margin-top: -74px;" class="nav ftco-animate justify-content-center">
                           <?php 
                                    ...
                                    {
                                    ;?>
                          <a style="font-size:28px" class="nav-link"  aria-selected="true" href="product_by_category.php?id_dm=<?php echo $row["danh_muc_id"];?>"><?php echo $row["ten_danh_muc"] ?></a>
                          <?php }; ?>
                    </div>
                ...
                <div class="col-md-12 nav-link-wrap mb-5">
                  ...
                  <div class="tab-pane fade show active" id="v-pills-1" role="tabpanel" aria-labelledby="v-pills-1-tab"> -->
                    <div style="margin-left: 3px;" class="roww">
                         <?php 
                    $ket_noi1 =mysqli_connect("localhost","id20271901_j02","N2)59(wRVeWAQ1t%","id20271901_ss_j02");
                    $id_dm =$_GET['id_dm'];
                    $sql1 ="SELECT * FROM tbl_san_pham
                    WHERE danh_muc_id = ".$id_dm." ";
                    $san_pham1=mysqli_query($ket_noi1,$sql1);
                    while($row=mysqli_fetch_array($san_pham1))
                    {
                    ;?>
  ...
  echo "<a href='product_by_category.php?page=".($page-1)."'>  Prev </a>"; //quay lại trang trước
  ...
  $pagLink .= "<a class = 'active' href='product_by_category.php?page="
  ...
  $pagLink .= "<a href='product_by_category.php?page=".$i."'>
  ...
  echo "<a href='product_by_category.php?page=".($page+1)."'>  Next </a>";
